...
<style>
  ...
  *{box-sizing:border-box}
  ...
  body{margin:0;display:flex;flex-direction:column;min-height:100vh;background:var(--paper);color:var(--ink);font-family:var(--font-body);line-height:1.5;padding-top:86px}
  a{color:inherit;text-decoration:none}
  .wrap{max-width:1120px;margin:0 auto;padding:0 28px}
  footer{margin-top:auto}

  .site-header{border-bottom:2px solid var(--ink);position:fixed;top:0;left:0;right:0;background:var(--ink);color:var(--paper);z-index:50}
  ...
  <div class="wrap">
    ...
    <details class="profile-menu">
      ...
      <div class="profile-dropdown">
        <a href="user/login"><?= __('nav_connexion') ?></a>
        <a href="user/register"><?= __('nav_inscription') ?></a>
      </div>
    </details>
  </div>
</header>
  ...
  <div class="wrap">
    ...
    <div class="grid">
      <?php foreach ($recettes as $i => $r): ?>
        <a class="card" href="/recipe/recette?id=<?= $r['id'] ?>">
...
<footer>
  <div class="wrap">
    ...
    <div style="display:flex;gap:20px;align-items:center">
      ...
      <a href="/legal-notices/mentions-legales" style="text-decoration:none"><?= __('footer_mentions') ?></a>
    </div>
  </div>
</footer>
