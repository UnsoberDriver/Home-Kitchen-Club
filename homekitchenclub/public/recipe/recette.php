...
<head>
  ...
  <link rel="icon" href="/picture/image?f=logo.png">
    ...
    <div class="wrap" style="display:block">
      ...
      <?php if (!empty($recette['image_url'])): ?>
        <div class="thumb-big" style="width:100%;margin-top:16px">
          <img src="/picture/image?f=<?= urlencode($recette['image_url']) ?>"
            alt="<?= htmlspecialchars($recette['titre']) ?>" loading="eager" fetchpriority="high" decoding="async">
        </div>
      <?php else: ?>
